...
BASE_TENSOR_DIR  = "/home/sbl_lab1/protein_design/long_chain_design/clamp_tensors_125_A53-56"
BASE_OUTPUT_DIR  = "/home/sbl_lab1/protein_design/long_chain_design/RFDiffusion_designs_125_A53-56"
RFDIFF_SCRIPT    = "/home/sbl_lab1/protein_design/RFdiffusion/scripts/run_inference.py"

BINDER_LENGTHS      = range(115, 126)
DESIGNS_PER_LENGTH  = 7
# Target is now chain B because binder comes first in the contig
HOTSPOTS            = "[B30,B31,B32,B33,B53,B54,B55,B56]"
GPU_UUID            = "GPU-2df4463e-120d-947a-2053-d23ef13eb073"
...
for blen in BINDER_LENGTHS:
    ...
    command = [
        ...
        f"contigmap.contigs=[{blen}-{blen}/0 A1-71]",   # binder first, target second
        "inference.model_runner=ScaffoldedSampler",
        f"ppi.hotspot_res={HOTSPOTS}",                   # hotspots now on chain B
